...
* 😎Easy to deploy: Support various backends including **ncnn, MNN and OpenVINO**. Also provide **Android demo** based on ncnn inference framework.(支持各种后端，包括**ncnn、MNN和OpenVINO**。还提供基于ncnn推理框架的**Android演示**。)
